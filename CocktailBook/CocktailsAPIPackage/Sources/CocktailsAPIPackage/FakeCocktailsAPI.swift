...
//    private var failure: CocktailAPIFailure
    public var queue = DispatchQueue(label: "CocktailsAPI")
    public var jsonData: Data
    public var failure: CocktailAPIFailure
   ...
   public init(withFailure failure: CocktailAPIFailure = .never) {
    ...
    public func fetchCocktails(completion: @escaping (Result<[Cocktail], Error>) -> Void) {
